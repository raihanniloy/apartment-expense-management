...
public class AdminController {
    ...
    public String dashboard(Model model){
        ...
        return loadAdminDashboard(model, expenseDTOList, expenseIncomeSummaryMap, expenseIncomeSummaryDTO);
    }
    ...
    public String loadAdminDashboard(Model model, List<ExpenseDTO> expenseDTOList, Map<String,Double> expenseIncomeSummaryMap, ExpenseIncomeSummaryDTO expenseIncomeSummaryDTO){
